  ...
  <div class="col-md-4 mx-auto">
    ...
    <form method="post" v-on:submit.prevent="register">
      <div class="form-group">
        ...
        <p class="text-danger" v-if="!$v.username.minLength">The Username must be at last {{ $v.username.$params.minLength.min }} symbols length.</p>
        <p class="text-danger" v-if="!$v.username.maxLength">The Username can be at most {{ $v.username.$params.maxLength.max }} symbols length.</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p class="text-danger" v-if="!$v.email.minLength">The Email address must be at last {{ $v.email.$params.minLength.min }} symbols length.</p>
        <p class="text-danger" v-if="!$v.email.maxLength">The Email address can be at most {{ $v.email.$params.maxLength.max }} symbols length.</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p class="text-danger" v-if="!$v.password.minLength">The Password length must be at last {{ $v.password.$params.minLength.min }} symbols length.</p>
        <p class="text-danger" v-if="!$v.password.maxLength">The Password length can be at most {{ $v.password.$params.maxLength.max }} symbols length.</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p class="text-danger" v-if="!$v.confirmPassword.sameAs">The Confirm password must match the password field.</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p class="text-danger" v-if="!$v.firstName.minLength">The First name length must be at last {{ $v.firstName.$params.minLength.min }} symbols length.</p>
        <p class="text-danger" v-if="!$v.firstName.maxLength">The First name length can be at most {{ $v.firstName.$params.maxLength.max }} symbols length.</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p class="text-danger" v-if="!$v.lastName.minLength">The Last name length must be at last {{ $v.lastName.$params.minLength.min }} symbols length.</p>
        <p class="text-danger" v-if="!$v.lastName.maxLength">The Last name length can be at most {{ $v.lastName.$params.maxLength.max }} symbols length.</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p class="text-danger" v-if="!$v.address.minLength">The Address length must be at last {{ $v.address.$params.minLength.min }} symbols length.</p>
        <p class="text-danger" v-if="!$v.address.maxLength">The Address length can be at most {{ $v.address.$params.maxLength.max }} symbols length.</p>
      </div>
