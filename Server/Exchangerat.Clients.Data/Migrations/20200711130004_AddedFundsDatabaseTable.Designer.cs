...
namespace Exchangerat.Clients.Data.Migrations
{
    ...
    [Migration("20200711130004_AddedFundsDatabaseTable")]
    partial class AddedFundsDatabaseTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exchangerat.Clients.Data.Models.Fund", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("CardIdentityNumber")
                        .IsRequired()
            ...
            modelBuilder.Entity("Exchangerat.Clients.Data.Models.Fund", b =>
                {
                    b.HasOne("Exchangerat.Clients.Data.Models.ExchangeAccount", "Account")
                        .WithMany("Funds")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Exchangerat.Clients.Data.Models.Client", "Client")
                        .WithMany("Funds")
